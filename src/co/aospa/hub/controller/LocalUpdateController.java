...
public class LocalUpdateController {
    ...
    private synchronized void copyUpdateToDir(String destination, UpdateInfo update) {
        String path = destination + "/" + update.getName();
        ...
        Runnable copyUpdateRunnable = new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Utils.setPermissions(updateFile, FileUtils.S_IRWXU | FileUtils.S_IRGRP | FileUtils.S_IROTH, -1, -1);
