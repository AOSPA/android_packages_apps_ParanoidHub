...
public class Version {
    ...
    public boolean isAndroidUpgrade() {
        return (Float.parseFloat(mAndroidVersion) > getAndroidVersion() && mBuildType.equals(getBuildType())) || (Float.parseFloat(mAndroidVersion)mAndroidVersion > getAndroidVersion() && !mBuildType.equals(getBuildType()) && mAllowBetaUpdates);
    }

    public static float getAndroidVersion() {
        return Float.parseFloat(SystemProperties.get(Constants.PROP_VERSION_ANDROID));
    }
