...
public class Version {
    ...
    public boolean isUpdateAvailable() {
        ...
        Log.d(TAG, mName + " Version:" + mVersion
    ...
    public static String getCurrentVariant() {
        return SystemProperties.get(Constants.PROP_VERSION_VARIANT);
    }
    ...
    public static long getCurrentTimestamp() {
        ...
        if (TYPE_BETA.toLowerCase().equals(getCurrentVariant().toLowerCase()) {
           date = split[5];
        } else {
           date = split[4];
        }
