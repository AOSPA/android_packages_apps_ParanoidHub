...
public class HubDbHelper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + UpdateEntry.TABLE_NAME + " (" +
                    ...
                    UpdateEntry.COLUMN_NAME_VERSION_NUMBER + " TEXT," +
    ...
    private static void fillContentValues(Update update, ContentValues values) {
        ...
        values.put(UpdateEntry.COLUMN_NAME_VARIANT, update.getBuildVariant());
        values.put(UpdateEntry.COLUMN_NAME_VERSION, update.getVersionMajor());
        values.put(UpdateEntry.COLUMN_NAME_VERSION_NUMBER, update.getVersionMinor());
    ...
    public List<Update> getUpdates(String selection, String[] selectionArgs) {
        ...
        String[] projection = {
                ...
                UpdateEntry.COLUMN_NAME_VERSION_NUMBER,
        ...
        if (cursor != null) {
            while (cursor.moveToNext()) {
                ...
                update.setBuildVariant(cursor.getString(index));
                index = cursor.getColumnIndex(UpdateEntry.COLUMN_NAME_VERSION);
                update.setVersionMajor(cursor.getString(index));
                index = cursor.getColumnIndex(UpdateEntry.COLUMN_NAME_VERSION_NUMBER);
                update.setVersionMinor(cursor.getString(index));
