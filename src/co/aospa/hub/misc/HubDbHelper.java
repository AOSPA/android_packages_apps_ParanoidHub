...
public class HubDbHelper extends SQLiteOpenHelper {
    ...
    private static void fillContentValues(Update update, ContentValues values) {
        ...
        values.put(UpdateEntry.COLUMN_NAME_TYPE, update.getBuildType());
        values.put(UpdateEntry.COLUMN_NAME_VERSION, update.getVersion());
        values.put(UpdateEntry.COLUMN_NAME_VERSION_NUMBER, update.getVersionNumber());
    ...
    public List<Update> getUpdates(String selection, String[] selectionArgs) {
        ...
        if (cursor != null) {
            while (cursor.moveToNext()) {
                ...
                update.setBuildType(cursor.getString(index));
                ...
                update.setVersionNumber(cursor.getString(index));
