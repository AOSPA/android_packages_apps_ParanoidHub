...
public class UpdateVerificationErrorState implements State {

    private final Update mUpdate;

    public UpdateVerificationErrorState(UpdateComponent updateComponent, ChangelogComponent changelogComponent) {
    ...
    public String getStepperText(Context context) {
        return context.getResources().getString(R.string.system_update_update_download_install_error_step_verify_issue);
    }
