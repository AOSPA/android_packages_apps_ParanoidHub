...
public class UpdateDownloadPausedState implements State {

    private final Update mUpdate;

    public UpdateDownloadPausedState(UpdateComponent updateComponent, ChangelogComponent changelogComponent) {
        mUpdate = new Update(updateComponent, changelogComponent);
    }

    @Override
    public String getHeaderText(Context context) {
        return context.getResources().getString(R.string.system_update_update_download_install_paused);
    }
    ...
    public String getActionText(Context context) {
        return context.getResources().getString(R.string.system_update_update_download_install_resume_button);
    }
    ...
    public View.OnClickListener getAction(Context context) {
        return view -> {
            ...
            intent.putExtra(Constants.EXTRA_DOWNLOAD, Constants.EXTRA_DOWNLOAD_ACTION_RESUME);
