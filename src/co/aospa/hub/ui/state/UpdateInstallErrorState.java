...
public class UpdateInstallErrorState implements State {

    private final Update mUpdate;

    public UpdateInstallErrorState(UpdateComponent updateComponent, ChangelogComponent changelogComponent) {
    ...
    public String getStepperText(Context context) {
        return context.getResources().getString(R.string.system_update_update_download_install_error_step_install_issue);
    }
