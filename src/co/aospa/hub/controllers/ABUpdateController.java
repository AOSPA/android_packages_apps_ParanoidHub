...
public class ABUpdateController extends UpdateEngineCallback {
    ...
    public static synchronized boolean isInstalling(Context context) {
        ...
        return preferenceHelper.getIntValueByKey(
                Constants.KEY_IS_INSTALLING_UPDATE) == UpdateController.StatusType.INSTALL;
    }
    ...
    public void onStatusUpdate(int status, float percent) {
        ...
        switch (status) {
            ...
            case UpdateEngine.UpdateStatusConstants.UPDATED_NEED_REBOOT: {
                mController.notifyUpdateListener(UpdateController.StatusType.REBOOT, -1);
            }
            break;
        }
    }
