...
public class NotificationController {
    ...
    private static NotificationController mController;
    ...
    public static synchronized NotificationController get(Context context) {
        if (mController == null) {
    ...
    public void showNotification(int notificationType, UpdateComponent component) {
        NotificationChannel notificationChannel = new NotificationChannel(
                "system_updates_notification_channel",
    ...
    private PendingIntent getIntent(int notificationType) {
        ...
        if (notificationType == NotificationType.TESTERS) {
            ...
            notificationIntent = new Intent(mContext, HubActivity.class);
        }
