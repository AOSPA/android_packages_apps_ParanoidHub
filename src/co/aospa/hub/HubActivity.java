...
import co.aospa.hub.activities.ChangelogActivity;
...
public class HubActivity extends AppCompatActivity implements View.OnClickListener, StatusListener {
    ...
    private void showDetailedChangelog(Changelog changelog, Update update) {
    ...
    public void onClick(View v) {
        ...
        if (v == mButton) {
            ...
            if (update != null) {
                showDetailedChangelog(mManager.getChangelog(), update);
            }
        }
    }
