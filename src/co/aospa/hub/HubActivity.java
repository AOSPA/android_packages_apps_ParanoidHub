...
public class HubActivity extends AppCompatActivity implements View.OnClickListener, StatusListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.hub_content).getVisibility() != View.VISIBLE) {
            findViewById(R.id.hub_content).setVisibility(View.VISIBLE);
        }
    ...
    private void showDetailedChangelog(Changelog changelog) {
        findViewById(R.id.hub_content).setVisibility(View.GONE);
        FragmentTransaction ft = getSupportFragmentManager().beginTransaction();
        Fragment changelogFragment = ChangelogFragment.newInstance(changelog.get(), changelog.getVersion(),
                changelog.getVersionNumber(), changelog.getBuildType());
        ft.replace(R.id.fragment_container_view, changelogFragment);
