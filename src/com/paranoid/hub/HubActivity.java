...
public class HubActivity extends AppCompatActivity implements View.OnClickListener, StatusListener {
    ...
    private static final int STATE_INSTALL_SUSPENDED = 8;
    private static final int STATE_RESTART = 9;
    ...
    private void updateMessages(UpdateInfo update) {
        switch (mState) {
            ...
            case STATE_INSTALL:
                ...
                mInfoDescription.setText(getResources().getString(Utils.isABDevice() ? R.string.install_warning_and_desc_ab : install_warning_and_desc));
        ...
        boolean infoAllowed = (mState == STATE_FOUND || mState == STATE_INSTALL || mState == STATE_INSTALLING);
