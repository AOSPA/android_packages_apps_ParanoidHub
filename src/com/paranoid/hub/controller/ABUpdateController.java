            ...
            switch (status) {
                ...
                case UpdateEngine.UpdateStatusConstants.FINALIZING: {
                    if (update.getStatus() != UpdateStatus.INSTALLING) {
                        ...
                        mController.notifyUpdateStatusChanged(HubController.STATE_STATUS_CHANGED, mDownloadId);
                    }
                    ...
                    mController.notifyUpdateStatusChanged(HubController.STATE_INSTALL_PROGRESS, mDownloadId);
                }
                break;
