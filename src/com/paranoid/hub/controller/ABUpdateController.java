...
public class ABUpdateController implements UpdateEngineCallback{
    ...
    private void setSuspended(boolean suspended) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(mContext);
        prefs.edit().putBoolean(Constants.IS_INSTALL_SUSPENDED, installing).apply();
        setInstalling(!suspend);
    }
    ...
    private String getDownloadId() {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(mContext);
        return pref.getString(Constants.DOWNLOAD_ID_AB, null);
    }

    public static synchronized boolean isInstalling(Context context) {
        SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(context);
        return pref.getBoolean(Constants.IS_INSTALLING_AB, false);
    }

    public static synchronized boolean isInstallSuspended(Context context) {
        SharedPreferences pref = PreferenceManager.getDefaultSharedPreferences(context);
        return pref.getString(Constants.IS_INSTALL_SUSPENDED, false);
    }
