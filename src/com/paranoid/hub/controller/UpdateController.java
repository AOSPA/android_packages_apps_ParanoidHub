...
public class UpdateController {
    ...
    private void installPackage(File update, String downloadId) {
        try {
            ...
            mController.notifyUpdateStatusChanged(HubController.STATE_STATUS_CHANGED, downloadId);
        }
    }
        ...
        Runnable copyUpdateRunnable = new Runnable() {
            ...
            FileUtils.ProgressCallBack mProgressCallBack = new FileUtils.ProgressCallBack() {
                ...
                public void update(int progress) {
                    ...
                    if (mLastUpdate < 0 || now - mLastUpdate > 500) {
                        ...
                        mController.notifyUpdateStatusChanged(HubController.STATE_INSTALL_PROGRESS, update.getDownloadId());
                        mLastUpdate = now;
                    }
                }
            };
            ...
            public void run() {
                try {
                    ...
                    mController.notifyUpdateStatusChanged(HubController.STATE_STATUS_CHANGED, update.getDownloadId());
                }
            }
        };
