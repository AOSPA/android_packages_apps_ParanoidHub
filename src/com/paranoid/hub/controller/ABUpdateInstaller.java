...
public class ABUpdateInstaller {
    ...
    private ABUpdateInstaller(Context context, HubUpdateController controller) {
        mController = controller;
        mContext = context.getApplicationContext();
        mUpdateEngine = new UpdateEngine();
    }

    public static synchronized ABUpdateInstaller getInstance(Context context,
            HubUpdateController controller) {
        if (sInstance == null) {
            sInstance = new ABUpdateInstaller(context, controller);
        }
        return sInstance;
    }
    ...
    public boolean install(String downloadId) {
        ...
        mController.getActualUpdate(mDownloadId).setStatus(UpdateStatus.INSTALLING);
        mController.notifyUpdateStatusChanged(HubUpdateController.STATE_STATUS_CHANGED, mDownloadId);
