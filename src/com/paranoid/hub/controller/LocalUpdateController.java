...
public class LocalUpdateController {
    ...
    public UpdateInfo buildUpdate(Uri uri) {
        ...
        update.setTimestamp(getTimestamp(file.getName()));
        update.setDownloadId(getDummyId(file.getName()));
        update.setVersion(getVersion(file.getName()));
        update.setPersistentStatus(UpdateStatus.Persistent.LOCAL_UPDATE);
        return update;
    }

    public UpdateInfo getUpdate(Uri uri) {
        UpdateInfo update = buildUpdate(uri);
        return update;
    }
