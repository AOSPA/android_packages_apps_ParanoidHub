...
public class NotificationContract {
    ...
    public NotificationContract(Context context, NotificationManager manager, String channel, boolean highImportance) {
        ...
        mBuilder.setColor(getColor(R.color.theme_accent));
        mBuilder.setShowWhen(false);

        Intent hub = new Intent(this, HubActivity.class);
        PendingIntent intent = PendingIntent.getActivity(this, 0, hub,
                PendingIntent.FLAG_UPDATE_CURRENT);
        mBuilder.setContentIntent(intent);
        
    }

    public NotificationCompat.Builder write() {
    ...
    public void setAction(int icon, CharSequence title, PendingIntent intent) {
        Notification.Action action = new NotificationCompat.Action(icon, title, intent);
